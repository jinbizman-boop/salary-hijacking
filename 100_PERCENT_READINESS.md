...
- Current HEAD: `705428ca983b2ad61b1995a7b1f44f5d1b48b386`
...
| GAP-008 | P0       | BLOCKED | Production AAB, Play upload/submit, main merge, and production release actions are not approved.         | `release/evidence/external-blockers.json`         | Obtain explicit production release approval, then execute documented production release commands.                                                                                                                                                                              |
...
- Release branch is merged/pushed to the release target branch after explicit approval
