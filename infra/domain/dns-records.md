...
| `admin.salaryhijacking.com`         | CNAME/custom domain | `salary-hijacking-admin` Pages project  | admin console                 |
...
- Cloudflare Pages custom domain routes to `salary-hijacking-admin`.
