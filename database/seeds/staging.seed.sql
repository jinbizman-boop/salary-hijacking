...
VALUES
  (
    '10000000-0000-4000-8000-000000002501',
    'READING',
    'Money habit checklist reading',
    'Read an operator summary and choose one habit to test.',
    'ECONOMY_BUSINESS',
    'EASY',
    8,
    ARRAY['budget', 'habit', 'reflection']::text[],
    'Owned operator summary about using a short checklist to notice one repeat spending habit before payday. No book or article text is stored.',
    'Choose one budget habit from the summary and write how you will test it today.',
    'Which one spending habit will you observe today?',
    'Salary Hijacking owned reading brief',
    'Salary Hijacking Editorial',
    'Salary Hijacking',
    ...
    true,
    false,
    jsonb_build_object('seed', 'staging', 'copyrightSafe', true, 'fullTextStored', false),
    '2026-07-11 09:00:00+09'
  ),
  (
    '10000000-0000-4000-8000-000000002502',
    'NEWS',
    'Balanced money news brief',
    'Practice source-centered reading without political labels.',
    'NEWS_LITERACY',
    'NORMAL',
    10,
    ARRAY['news', 'source', 'budget']::text[],
    'Owned brief explaining how to compare what changed, who is affected, and what source evidence is available before applying news to a budget decision.',
    'Write one fact, one uncertainty, and one budget action you would delay until more evidence appears.',
    'What fact did the source actually support?',
    'Salary Hijacking source balance method',
    'Salary Hijacking Editorial',
    'Salary Hijacking',
    'https://salaryhijacking.com/level/news/source-balance-method',
    'OWNED_CONTENT',
    'GENERAL',
    'FACT_BRIEF',
    25,
    ...
    true,
    false,
    jsonb_build_object('seed', 'staging', 'storesFullArticle', false, 'visiblePoliticalLabel', false),
    '2026-07-11 09:05:00+09'
  ),
  (
    '10000000-0000-4000-8000-000000002503',
    'ENGLISH',
    'Payday five sentence practice',
    'Listen, read, speak, and write five owned sentences.',
    'ENGLISH_FINANCE',
    'EASY',
    7,
    ARRAY['english', 'payday', 'sentence']::text[],
    'Owned English practice with five short salary and budget sentences. Voice and text practice are private learning records and are not used for ads.',
    'Practice the five sentences, then write one sentence about your next payday plan.',
    'Which sentence was easiest to say aloud?',
    'Salary Hijacking owned English set',
    'Salary Hijacking Editorial',
    'Salary Hijacking',
    ...
    true,
    false,
    jsonb_build_object('seed', 'staging', 'ownedSentences', true, 'voiceUsedForAds', false),
    '2026-07-11 09:10:00+09'
  ),
  (
    '10000000-0000-4000-8000-000000002504',
    'HEALTH',
    'Desk recovery starter routine',
    'A beginner safe timer checklist for light movement.',
    'HEALTH_ROUTINE',
    'EASY',
    9,
    ARRAY['health', 'timer', 'recovery']::text[],
    'Owned beginner routine for gentle desk recovery. Stop if pain appears and use the recovery option instead of pushing intensity.',
    'Run the timer checklist once and record whether any movement felt uncomfortable.',
    'Did any movement cause pain or discomfort?',
    'Salary Hijacking owned desk recovery routine',
    'Salary Hijacking Editorial',
    'Salary Hijacking',
    ...
    true,
    false,
    jsonb_build_object('seed', 'staging', 'beginnerSafe', true, 'painStopNotice', true, 'medicalDisclaimer', true),
    '2026-07-11 09:15:00+09'
  )
ON CONFLICT (content_id) DO UPDATE
SET
  title = EXCLUDED.title,
  summary = EXCLUDED.summary,
  mission_prompt = EXCLUDED.mission_prompt,
  record_question = EXCLUDED.record_question,
