...
VALUES
  (
    '20000000-0000-4000-8000-000000002501',
    'READING',
    ...
    true,
    false,
    jsonb_build_object('seed', 'uat', 'copyrightSafe', true, 'fullTextStored', false),
    '2026-07-11 09:00:00+09'
  ),
  (
    '20000000-0000-4000-8000-000000002502',
    'NEWS',
    ...
    true,
    false,
    jsonb_build_object('seed', 'uat', 'storesFullArticle', false, 'visiblePoliticalLabel', false),
    '2026-07-11 09:05:00+09'
  ),
  (
    '20000000-0000-4000-8000-000000002503',
    'ENGLISH',
    ...
    true,
    false,
    jsonb_build_object('seed', 'uat', 'ownedSentences', true, 'voiceUsedForAds', false),
    '2026-07-11 09:10:00+09'
  ),
  (
    '20000000-0000-4000-8000-000000002504',
    'HEALTH',
    ...
    true,
    false,
    jsonb_build_object('seed', 'uat', 'beginnerSafe', true, 'painStopNotice', true, 'medicalDisclaimer', true),
