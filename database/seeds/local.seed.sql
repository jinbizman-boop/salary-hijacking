...
VALUES
  (
    ...
    true,
    false,
    jsonb_build_object('seed', 'local', 'copyrightSafe', true, 'fullTextStored', false),
  ...
  (
    ...
    true,
    false,
    jsonb_build_object('seed', 'local', 'storesFullArticle', false, 'visiblePoliticalLabel', false),
  ...
  (
    ...
    true,
    false,
    jsonb_build_object('seed', 'local', 'ownedSentences', true, 'voiceUsedForAds', false),
  ...
  (
    ...
    true,
    false,
    jsonb_build_object('seed', 'local', 'beginnerSafe', true, 'painStopNotice', true, 'medicalDisclaimer', true),
