...
const storeCaptures = [
  ["/capture/salary", "01_home_salary.png"],
  ["/capture/salary?focus=daily-budget", "02_daily_budget.png"],
  ["/capture/plan", "03_plan_setting.png"],
  ["/capture/notifications", "04_notifications.png"],
  ["/capture/level", "05_level_up.png"],
