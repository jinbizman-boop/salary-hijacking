...
- root script tests: PASS, 176 tests after adding Android SDK tool detection
  ...
  dependency security audit proof artifact guarding, tracked proof example
  templates, missing/BOM Cloudflare observation handling, and UTF-8 BOM local
  proof handling for database and mobile native collectors
