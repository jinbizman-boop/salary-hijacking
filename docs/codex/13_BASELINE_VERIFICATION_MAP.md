...
| Git visibility              | `git status --short`; `git remote -v`                                          | WARN                  | Local Git repository is initialized and `git status` runs. All files are currently untracked and no remote is configured.                                                                                                                                                                                                                               |
