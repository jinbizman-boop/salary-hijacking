...
const contentTypes = ["READING", "ENGLISH", "EXERCISE", "NEWS"] as const;
...
function guardCards(): string[] {
  return [
    ...
    ["medicalDisclaimer for exercise", true],
    ["painStopNotice for exercise", true],
...
function assertAdminGrowthContentPageCompleteness(): {
  ...
  const checks = [
    ...
    "medicalDisclaimer_for_exercise",
    "painStopNotice_for_exercise",
