...
export default function SalaryNotificationsIndexScreen(): React.ReactElement {
  const router = useRouter();
  const goBack = useLogicalBack({ fallbackHref: "/salary", router });
  ...
  return (
    <NotificationScreen
      ...
      onSettings={() => router.push("/salary/notifications/settings" as never)}
