...
describe("mobile Detox E2E contract", () => {
  ...
  it("keeps production EAS archive able to upload CI-generated google-services file", () => {
    ...
    expect(workflow).toContain("easArchiveAllowsRuntimeAssets");
    expect(workflow).toContain("runtimeAssetsPresent");
    ...
    expect(workflow).toContain("scripts/expo-local-android-production-build.mjs");
